...
T16 confirmed protocol `0.1.2` and a successful boot-slot response. Its boot
flash value 255 is a second BASIC NUL-decoding artifact: flash slot zero was
returned as an empty string while the diagnostic default remained 255. T17
initializes the boot fields to zero and preserves every existing safety gate.
