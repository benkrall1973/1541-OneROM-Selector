#!/usr/bin/env python3
"""Replace the only PRG in the release D64, reusing its existing sector chain."""
...
def main() -> None:
    ...
    parser.add_argument("--file-name", default="ONEROMT11001")
    parser.add_argument("--disk-name", default="ONEROM T11001")
