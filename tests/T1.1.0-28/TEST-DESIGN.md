...
T28 retains the selective old-row/new-row redraw for both menus. It changes the IEC help text to the ROM menu's compact `KEY=ACTION` style without changing selection behavior.
