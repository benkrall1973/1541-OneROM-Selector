# T1.1.0-33 ROM highlight alignment fix

This test retains T32's presentation and corrects the selective ROM-row redraw after the header was raised one line. Up/Down now erases the previous highlight and draws exactly one highlight on the selected candidate.
...
3. Run `ONEROMT11033`, make no selection change, and press Q.
