# T1.1.0-34 centered IEC countdown

This test retains T33's corrected single-highlight ROM menu and centers the complete `AUTO SELECT IN [XX]` countdown field on the IEC screen.
...
3. Run `ONEROMT11034`, make no selection change, and press Q.
...
6. Exercise ROM-menu movement and confirm exactly one candidate row is highlighted, the old row is restored, and the blank line below `ACTIVE:` remains visible.
