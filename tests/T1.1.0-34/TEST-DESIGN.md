...
T34 moves the fixed-width 19-character countdown field from columns 3–21 to columns 10–28, centering it on the 40-column IEC screen. It retains direct screen/color-memory updates, so each second changes only the two digits and causes no redraw.
